                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="title-block">
                            ...
                            <div class="home-buttons">
                                <a href="#about-me" class="bt-submit"><img src="styles\site\default\assets\images\play.png" style="width: 30px; height: 30px; vertical-align: middle;"> Iniciemos</a>
                                <a href="quizz/index.html" class="bt-submit" target="_blank"><img src="styles\site\default\assets\images\quizz.png" style="width: 30px; height: 30px; vertical-align: middle;"> ¡Juguemos!</a> <br>
                ...
                <div class="section-content">
                    ...
                    <div class="row pb-30">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <h3> Historia de la Ingeniería de Software</h3>
